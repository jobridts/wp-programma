...
global $current_user;
 ...
 $icon_url = plugins_url('images/plugin-menu-icon32.png', __FILE__);
  ...
  echo '<p>Voer hier bij een activiteit toe die in de Agenda moet komen.</p>';
...
<p><input type="submit" value="Verzenden" name="activiteit_update"  class="button-primary" /></p>
  </form>
  </div>